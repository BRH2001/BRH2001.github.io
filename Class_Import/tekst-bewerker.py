...
class TekstEditor:
    def __init__(self):
        ...
        # Label
        self.label = tk.Label(self.frame, text="Voer tekst in:", font=("Arial", font_size), fg="#FFFFFF", bg="#000000")
        self.label.pack()
        ...
        self.full_case_button = tk.Button(button_frame, text="Hoofdletters", command=self.full_case_text, font=("Arial", font_size), bg="#808080", fg="#FFFFFF")
        self.full_case_button.pack(side=tk.LEFT, pady=5)

        self.small_case_button = tk.Button(button_frame, text="Kleine letters", command=self.small_case_text, font=("Arial", font_size), bg="#808080", fg="#FFFFFF")
        self.small_case_button.pack(side=tk.LEFT, pady=5)

        self.reverse_button = tk.Button(button_frame, text="Omkeren", command=self.reverse_text, font=("Arial", font_size), bg="#808080", fg="#FFFFFF")
